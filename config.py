...
LIMIT_INCREASE_AMOUNT = 5  # Amount by which the limit is increased after verification
AUTO_DELETE_DELAY = 3600  # Time in seconds after which messages will be deleted (600 seconds = 10 minutes)
